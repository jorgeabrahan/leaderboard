...
**Leaderboard** project created with JavaScript/ES6, Webpack, and following Gitflow structure. It also works with an external leaderboard API service.
...
```
git clone https://github.com/jorgeabrahan/leaderboard.git
```
...
To run the project, if you are on the leaderboard folder path on your terminal you can execuhe followinte tg command:
